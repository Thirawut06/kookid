        ...
        <Card className="p-6 sm:p-8 border-border/60 shadow-sm space-y-6 text-sm sm:text-base text-foreground/80">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc list-inside ml-2 space-y-1 text-muted-foreground">
              ...
              <li>ส่งต่อข้อมูลให้แก่มหาวิทยาลัย หรือสถาบันการศึกษาที่เป็นพันธมิตร <span className="font-semibold text-foreground">เพื่อพิจารณาเสนอสิทธิ์โควต้าหรือทุนการศึกษา (เฉพาะในกรณีที่คุณกดยืนยันความสนใจและยินยอมเท่านั้น)</span></li>
